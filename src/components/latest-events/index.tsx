...
const LastestEvents: React.FC<LastestEventsProps> = async ({ events, locale, isHomePage = true }) => {
  const t = await getTranslations('lastestEvents');

  // إذا كانت الصفحة الرئيسية، عرض 6 خدمات فقط، وإلا عرض الكل
  ...
  return (
    <div className="my-5 lg:my-10">
      ...
      <Container className="mt-7">
        ...
        {/* زر عرض المزيد إذا كان في الصفحة الرئيسية فقط وهناك أكثر من 6 أحداث */}
